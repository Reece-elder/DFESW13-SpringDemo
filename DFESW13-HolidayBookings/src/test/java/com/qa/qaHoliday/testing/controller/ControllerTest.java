...
public class ControllerTest {
	...
	public void testDeleteId() throws Exception {
		...
		ResultMatcher checkBody = content().string("Booking of id: 1 deleted"); // what string does the response entity respond with
		
		mvc.perform(req).andExpect(checkStatus).andExpect(checkBody); // Run the request and check the status and content		
	}
	...
	public void testGetAll() throws Exception {
		...
		List<HolidayBooking> allBookings = List.of(testBookingID, testBookingID2); // creating a list which contains these objects
